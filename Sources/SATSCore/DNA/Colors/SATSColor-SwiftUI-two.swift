...
extension Color {
    public struct SATS {
        ...
        public static var workoutsPt: Color { satsColor(for: .workoutsPt) }
        public static var workoutsGx: Color { satsColor(for: .workoutsGx) }
        public static var workoutsTreatments: Color { satsColor(for: .workoutsTreatments) }
        public static var workoutsGymfloor: Color { satsColor(for: .workoutsGymfloor) }
        public static var workoutsOwnTraining: Color { satsColor(for: .workoutsOwnTraining) }
        ...
        public static var signalSurfaceWaitlist: Color { satsColor(for: .signalSurfaceWaitlist) }
        ...
        public static var onWaitlistButton: Color { satsColor(for: .onWaitlistButton) }
        public static var onWaitlistButtonDisabled: Color { satsColor(for: .onWaitlistButtonDisabled) }
        ...
        public static var onSurfaceWaitlist: Color { satsColor(for: .onSurfaceWaitlist) }
        ...
        public static var onSignalSurfaceWaitlist: Color { satsColor(for: .onSignalSurfaceWaitlist) }
        public static var onSignalSurfaceWaitlistAlternate: Color { satsColor(for: .onSignalSurfaceWaitlistAlternate) }
...
//    SATSColor.action
    Color.sats.action
    Color.satsOne.action
    Color.action

    func bar(color: Color) {}


    bar(color: .action)
    bar(color: .sats.action)
//    bar(color: .s.action)
    bar(color: .satsOne.action)
    bar(color: .SATS.action)
//    bar(color: SATSColor.action) // UIColor
