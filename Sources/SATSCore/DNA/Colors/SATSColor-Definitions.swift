...
extension SATSColor {
    static let definitions: [SATSColorName: SemanticColorDefinition] = [
        ...
        .workoutsPt: .init(light: .uranianBlue100, dark: .uranianBlue70),
        .workoutsGx: .init(light: .salmonPink100, dark: .salmonPink70),
        .workoutsTreatments: .init(light: .caribbeanCurrent100, dark: .caribbeanCurrent70),
        .workoutsGymfloor: .init(light: .tangerine100, dark: .tangerine70),
        .workoutsOwnTraining: .init(light: .celadon100, dark: .celadon70),
        ...
        .backgroundFixed: .init(light: .satsBlue100, dark: .satsBlueGrey80),
        ...
        .signalSurfaceWaitlist: .init(light: .egyptianPurple10, dark: .egyptianPurple160),
        ...
        .onWaitlistButton: .init(light: .white100, dark: .white100),
        .onWaitlistButtonDisabled: .init(light: .white60, dark: .black50),
        ...
        .onSurfaceWaitlist: .init(light: .egyptianPurple100, dark: .egyptianPurple60),
        ...
        .onSignalSurfaceWaitlist: .init(light: .satsBlue100, dark: .white100),
        .onSignalSurfaceWaitlistAlternate: .init(light: .egyptianPurple100, dark: .egyptianPurple60),
