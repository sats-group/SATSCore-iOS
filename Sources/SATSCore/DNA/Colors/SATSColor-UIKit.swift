...
extension UIColor {
    ...
    public static var graphBarBackgroundPrimary: UIColor { satsColor(for: .graphBarBackgroundPrimary) }
    public static var graphBarBackgroundSecondary: UIColor { satsColor(for: .graphBarBackgroundSecondary) }
