...
public enum SATSColorName: String, CaseIterable {
    ...
    case workoutsPt
    case workoutsGx
    case workoutsTreatments
    case workoutsGymfloor
    case workoutsOwnTraining
    ...
    case onWaitlistButton
    case onWaitlistButtonDisabled
    ...
    case onSignalSurfaceWaitlist
    case onSignalSurfaceWaitlistAlternate
